<template>
  ...
  ></page-meta>
  <view class="evalist">
    <u-navbar title="新房" :autoBack="true" bgColor="#fff" :placeholder="true">
    </u-navbar>
    <view class="opsugDetail-search-vue-box">
      <View class="header-u-search-wrap">
        <u-search placeholder="请输入要查找的房产名称" :label="null"></u-search>
      </View>
      <!-- filter start -->
      <HMfilterDropdown
...
<script>
import HMfilterDropdown from "@/common/HM-filterDropdown/HM-filterDropdown.vue";
...
export default {
  ...
  onLoad() {
    ...
    // 危险区域 加 navbar 高度
    this.navFixedHeight = app.globalData.statusBarHeight + 91 + "px";
